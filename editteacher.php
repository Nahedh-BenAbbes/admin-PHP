...
<div class="container">
	...
	if(isset($_POST['update'])){
		...
		if( empty($_POST['first_name']) || empty($_POST['last_name'])   )
		{
			...
			$sql = "UPDATE teacher SET name='{$first_name}', last_name = '{$last_name}'
						WHERE idteacher=" . $_POST['idteacher'];

			if( $con->query($sql) === TRUE){
				echo "<div class='alert alert-success'>Successfully updated  Teacher</div>";
			}else{
	...
	$sql = "SELECT * FROM users WHERE idteacher={$id}";
	...
	<div class="col-md-6 col-md-offset-3">
		<div class="box">
			...
			<form action="" method="POST">
				<input type="hidden" value="<?php echo $row['idteacher']; ?>" name="idteacher">
